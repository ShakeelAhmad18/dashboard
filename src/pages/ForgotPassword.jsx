      ...
      <div className="w-full lg:w-1/2 bg-gray-50 flex flex-col justify-center py-20 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto w-full max-w-md">
          ...
          <div className="mt-14">
            ...
            <h2 className="mt-1 text-2xl font-bold text-gray-900 mb-1">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="mt-6">
                <Link to="/email-verify">
                  <button
                    type="submit"
                    className="w-full mt-6 flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gradient-to-r from-[#14ADD6] to-[#384295] hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                  >
                    Send
                  </button>
                </Link>
